    ...
    <div className={styles.pageContainer}>
      ...
      <div className={styles.bottom_container}>
        <div className={styles.info_image_container}>
          <Image src="/info-icon.svg" alt="Info" width={40} height={40} className={styles.info_image} />
          <div className={styles.tooltip_info}>
          This system helps the elevator maintenance team at Bukovel manage projects and tasks easily. It allows tracking deadlines, assigning tasks, and communicating with team members.
          It makes work more organized, improves productivity, and ensures smooth maintenance.
          </div>
        </div>
      </div>
    </div>
