...
export default function ProjectsTable({ onEditProject }: ProjectsTableProps) {
  ...
  const handleDeleteClick = async (e: React.MouseEvent, project: Project) => {
    ...
    if (window.confirm(`Are you sure you want to delete project "${project.name_project}"?`)) {
      setIsDeleting(true);
      try {
          ...
          <tbody>
            {projects.map((project) => (
              <tr 
                ...
                className={selectedProject?.id_project === project.id_project ? styles.selectedRow : ''}
              >
        ...
        <div className={styles.projectInfo}>
          <div className={styles.projectInfoHeader}>
            ...
            <div className={styles.projectInfoActions}>
              ...
              <button 
                className={styles.deleteButton}
                onClick={() => handleDeleteClick(new Event('click') as any, selectedProject)}
                disabled={isDeleting}
              >
                Delete Project
              </button>
          ...
          <div className={styles.projectInfoSection}>
            ...
            <div className={styles.projectInfoItem}>
              <span>Status</span>
              <span className={`${styles.projectInfoStatus} ${styles[selectedProject.status.toLowerCase()]}`}>
